    ...
    const downloadPDF = async () => {
        ...
        const drawHeader = (pageNumber: number) => {
            if (pageNumber === 1) {
                ...
                doc.text('CENTRE D\'EXCELLENCE - FACULTÉ DE SCIENCE ET TECHNOLOGIE', 125, 37, { align: 'center' });
                doc.setFontSize(8);
                                ...
                                <div className="bg-white w-full rounded-tr-[100px] rounded-bl-[100px] shadow-[0_40px_100px_rgba(0,0,0,0.5)] overflow-hidden text-slate-900 border-l-[15px] border-slate-900">
                                    ...
                                    <div className="p-10 space-y-6">
                                        <div className="text-center border-b-2 border-slate-900 pb-4 relative">
                                            ...
                                            <p className="text-[5px] font-bold text-slate-500 uppercase tracking-widest">FACULTÉ DE SCIENCE ET TECHNOLOGIE - DSI</p>
                                        </div>
