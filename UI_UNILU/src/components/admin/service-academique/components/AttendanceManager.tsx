...
import { FileText, CheckCircle, Users, Clock, Loader2, ChevronRight, AlertTriangle, RotateCcw, X, Download, Search } from 'lucide-react';
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-white rounded-[24px] border border-[#1B4332]/10 shadow-sm overflow-hidden">
                            ...
                            {/* Search Bar */}
                            <div className="p-4 border-b border-[#1B4332]/5 bg-gray-50/50">
                                <div className="relative">
                                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#52796F]" />
                                    <input
                                        type="text"
                                        placeholder="Rechercher par nom ou matricule..."
                                        className="w-full pl-9 pr-4 py-2 bg-white border border-[#1B4332]/10 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1B4332]/20 text-[#1B4332] placeholder:text-[#52796F]/50"
                                        value={searchTerm}
                                    ...
                                    {searchTerm && (
                                        ...
                                        >
                                            <X className="w-3 h-3 text-[#52796F]" />
                                        </button>
                                    )}
                                </div>
                            </div>
