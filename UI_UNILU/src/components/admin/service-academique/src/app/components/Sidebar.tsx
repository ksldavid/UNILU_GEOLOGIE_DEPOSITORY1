    ...
    <aside className="w-64 bg-sidebar text-sidebar-foreground p-6 flex flex-col">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg">EDUCORE</h2>
            <p className="text-xs text-sidebar-foreground/70">ACADEMIC PORTAL</p>
          </div>
        </div>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-[20px] transition-all ${
                isActive
